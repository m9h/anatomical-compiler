...
\begin{enumerate}
    ...
    \vspace{0.4em}
    \item \textbf{91.5\% direction concordance}\\
    {\small Within shared regulon members, CRISPRi knockdown produces expression changes in a consistent direction}

    \vspace{0.4em}
    \item \textbf{hgx is 5--120$\times$ faster than DHG}\\
    {\small JAX JIT compilation advantage, with validated accuracy on standard benchmarks}
