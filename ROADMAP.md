...
- [ ] Notebook 8 — cancer-as-loss-of-module-identifiability (stretch): run the MII (Lab 3) + driver-stability split (Lab 4) down a primary → organoid → tumour-organoid → cancer-line gradient; the anatomical compiler (Lab 6) as the "normalize, don't kill" reframing (Soto & Sonnenschein TOFT; Trigos et al. atavism; Levin 2021 bioelectric-cancer; §1.6 / §4.3(vi))
